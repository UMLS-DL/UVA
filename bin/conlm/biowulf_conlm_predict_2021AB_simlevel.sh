...
--start_epoch_predict=100 \
--end_epoch_predict=100 \
--logs_fp="$WORKSPACE/logs/predict_conlm_uva_run1_"$UMLS_VERSION"_MODEL_LEARNING_DS_TOPN_SIM_8192b_100e_exp2_All_Triples_TransE_SGD_100_150_uva_final_run1.log"; \
python $WORKSPACE/bin/run_umls_classifier.py \
--workspace_dp=$WORKSPACE \
--KGE_Home=$KGE_HOME \
--umls_version_dp=$WORKSPACE/UMLS_VERSIONS/$UMLS_VERSION \
...
--start_epoch_predict=100 \
--end_epoch_predict=100 \
--logs_fp="$WORKSPACE/logs/predict_conlm_uva_run1_"$UMLS_VERSION"_MODEL_LEARNING_DS_RAN_SIM_8192b_100e_exp2_All_Triples_TransE_SGD_100_150_uva_final_run1.log"; \
python $WORKSPACE/bin/run_umls_classifier.py \
--workspace_dp=$WORKSPACE \
--KGE_Home=$KGE_HOME \
--umls_version_dp=$WORKSPACE/UMLS_VERSIONS/$UMLS_VERSION \
...
--start_epoch_predict=100 \
--end_epoch_predict=100 \
--logs_fp="$WORKSPACE/logs/predict_conlm_uva_run1_"$UMLS_VERSION"_MODEL_LEARNING_DS_RAN_NOSIM_8192b_100e_exp2_All_Triples_TransE_SGD_100_150_uva_final_run1.log"
